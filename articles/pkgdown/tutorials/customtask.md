...
| 2021-Biden |     2 | The document emphasizes themes of unity, democracy, and addressing systemic issues such as racial justice and climate change, which align with progressive values. It also calls for government action to address economic challenges and public health, reflecting left-leaning priorities. However, the focus on unity and bipartisanship tempers the alignment with the political left, making it very left but not extremely so.                                        |
| 2025-Trump |     0 | The document aligns with a conservative political perspective, emphasizing nationalism, border security, military strength, and economic policies favoring deregulation and fossil fuel use. It criticizes government intervention and progressive policies, which are typically associated with the political left. Therefore, it does not align with the political left’s advocacy for social equality, government intervention in the economy, and progressive policies. |
