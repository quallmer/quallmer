...
you through the steps of using the Agreement App effectively.
...
## Calculating agreement scores such as Krippendorff’s alpha or Fleiss’ kappa
...
as Krippendorff’s alpha or Fleiss’ kappa, to assess the agreement
between different coders or between your manual codes and the LLM
annotations or, as shown below, between multiple LLM runs.
