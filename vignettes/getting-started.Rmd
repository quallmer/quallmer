...
4. [**Creating custom tasks**](https://seraphinem.github.io/quallmer/articles/pkgdown/tutorials/customtask.html): This tutorial will walk you through the process of defining your own custom annotation tasks using the `task()` function, allowing you to tailor the LLM's output to your specific research needs.

5. [**Using the Validate App**](https://seraphinem.github.io/quallmer/articles/pkgdown/tutorials/agreement.html): This tutorial will introduce you to the Agreement App to manually code data, check LLM annotations, and calculate interrater reliability in a user-friendly and intuitive interface.
