...
3. [**Using built-in codebooks**](https://seraphinem.github.io/quallmer/articles/pkgdown/examples/overview.html): These illustrations will show you how to utilize the library of built-in codebooks available in the `quallmer` package to perform common qualitative coding tasks efficiently.

4. [**Creating custom codebooks**](https://seraphinem.github.io/quallmer/articles/pkgdown/tutorials/custom-codebook.html): This tutorial will walk you through the process of defining your own custom codebooks using the `qlm_codebook()` function, allowing you to tailor the LLM's output to your specific research needs.
