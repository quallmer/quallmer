...
- The reliability measure used (here Krippendorff's alpha for ordinal data, the package also supports nominal, interval, and ratio levels and other measures such as Cohen's kappa) 
- The computed value  
- Number of subjects (speeches) and raters (coding runs) 
- An interpretation of the agreement level 

### Computing simple percent agreement

```{r compare-agreement}
# Simple percent agreement
agreement <- qlm_compare(coded1, coded3,
                         by = "score",
                         measure = "agreement")
