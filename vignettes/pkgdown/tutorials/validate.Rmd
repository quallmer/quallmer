...
![Screenshot of the Validate App manual coding interface showing text items with fields for scores, comments, and example sentences](pics/manual.png)
...
![Screenshot of the Validate App LLM annotation review interface displaying model-generated codes with justifications and validation options](pics/llm.png)
