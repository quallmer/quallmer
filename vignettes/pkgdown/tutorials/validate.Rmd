...
To launch the quallmer app, load the `quallmer.app` package and call the `qlm_app()` function. This will open the quallmer app in a new window or tab in your web browser.
