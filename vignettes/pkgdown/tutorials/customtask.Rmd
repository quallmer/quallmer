...
For more information on defining `type_object` and additional type specifications such as `type_array`, please refer to the [ellmer documentation on type specifications](https://ellmer.tidyverse.org/reference/type_boolean.html).
