...
All `qlm_coded`, `qlm_comparison`, and `qlm_validation` objects automatically capture provenance metadata including model parameters, timestamps, and parent-child relationships. This enables full workflow traceability and reproducibility.
...
- **Report**: Generate human-readable Quarto/RMarkdown documents summarizing the complete workflow history.
