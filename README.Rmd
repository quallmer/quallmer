...
- **Built-in codebook functions** (e.g., `codebook_sentiment()`, `codebook_stance()`) provide ready-to-use codebooks for common qualitative coding tasks.
- **Example codebook objects** (e.g., `data_codebook_sentiment`) demonstrate complete workflows paired with example datasets.
...
the illustrations on [how to use the built-in codebooks](https://seraphinem.github.io/quallmer/articles/pkgdown/examples/overview.html).
