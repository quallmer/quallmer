...
- **Example codebook objects** (e.g., `data_codebook_sentiment`, `data_codebook_stance`, `data_codebook_ideology`) demonstrate complete workflows for common qualitative coding tasks.
...
the [example codebook](https://seraphinem.github.io/quallmer/articles/pkgdown/examples/codebook_sentiment.html) illustrating a complete workflow.
